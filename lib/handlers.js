                                        ...
                                        _data.delete('checks', checkId, function (err) {
                                            ...
                                            if (checksDeleted === checksToDelete) {
                                                if (!deletionErrors) {
                                                    ...
                                                    callback(500, { 'Error': 'Error encounted while attempting to delete all user\'s checks. All checks may not have been deleted from the system successfully.' });
                                                }
                                            }
                                        })
                                    })
